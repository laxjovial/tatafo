    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                {(tool === 'finance_get_historical_stock_prices' && auth.user.tier === 'free') && <a href="/upgrade">Upgrade to a paid tier to use this feature.</a>}
                {(tool === 'crypto_get_historical_crypto_price' && auth.user.tier === 'free') && <a href="/upgrade">Upgrade to a paid tier to use this feature.</a>}
            </form>
