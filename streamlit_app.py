...
def main_app():
    ...
    # if st.sidebar.button("AI Assistant", key="sidebar_ai_assistant_button"):
    #     st.session_state.current_page = "AI Assistant"
    #     st.rerun()
    # if st.sidebar.button("User Profile", key="sidebar_user_profile_button"):
    #     st.session_state.current_page = "User Profile"
    #     st.rerun()
    # if st.sidebar.button("Admin Dashboard", key="sidebar_admin_dashboard_button"):
